...
def comprar_prdouto() -> None:
    if len(produtos) > 0:
        print('Informe o codigo do produto que deseja adicionar ao carrinho:')
        print('_____________________________________________________________')
        print('_____________________Produtos Disponiveis____________________')
        for produto in produtos:
            print(produto)
...
def fecha_pedido() -> None:
    if len(carrinho) > 0:
        ...
        print('Ainda não exisem produtos no carrinho.')
        sleep(2)
        menu()
